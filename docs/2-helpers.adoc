...
[source,gherkin]
----
include::../code/03-add-create-project-feature/features/create_project.feature[]
----

We've introduced a handful of new steps here. Let's look at how these are defined:
[source,js]
----
include::../code/03-add-create-project-feature/features/step_definitions/steps.js[]
----
